// lib/screens/static/privacy_policy_screen.dart
...
class _PrivacyPolicyScreenState extends State<PrivacyPolicyScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: provider.privacyLoading
          ? Center(child: CircularProgressIndicator(color: theme.primaryColor))
          : provider.privacyError != null
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  l10n.privacyPolicy,
                  style: TextStyle(fontSize: 22, fontWeight: FontWeight.w700, color: theme.colorScheme.onSurface),
                ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              onPressed: () => provider.loadPrivacyPolicy(),
