...
<head>
    ...
    <title>Request Accepted - NearbyFundi</title>
    <style>
    ...
    <div class="container">
        ...
        <div class="body-content">
            ...
            <div class="request-details">
                ...
                <p><span class="label">Accepted On</span><br><span class="value">{{ $request->updated_at->format('F d, Y') }} at {{ $request->updated_at->format('g:i A') }}</span></p>
            </div>

            <div class="highlight-box">
                <p>💚 The technician will contact you shortly to discuss the details.</p>
            </div>
            ...
            <!-- Action Buttons -->
            <div class="btn-group">
                <a href="{{ config('app.frontend_url') }}/my-requests" class="btn">
                    View My Requests
                </a>
                <a href="{{ config('app.frontend_url') }}" class="btn-outline">
                    Go to NearbyFundi
                </a>
            </div>
        </div>
